...
## Migration Engine (Normative – v0.1)

Status: Normative
Scope: Defines the execution model, contracts, and safety guarantees for applying migrations between two versions of a RIGOR specification.

This document formalizes how migrations are validated, ordered, and applied in a deterministic and safe manner.
